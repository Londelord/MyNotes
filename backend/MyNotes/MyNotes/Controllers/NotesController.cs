...
public class NotesController : ControllerBase
{
    ...
    [HttpDelete]
    public async Task<IActionResult> Delete([FromBody] DeleteNoteRequest request, CancellationToken ct)
    {
        await _dbContext.Notes.Where(n => n.Id == request.Id).ExecuteDeleteAsync();
